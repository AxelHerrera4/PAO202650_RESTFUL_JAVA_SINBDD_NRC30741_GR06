...
public class ConversorControlador {
    ...
    private static final String BASE_URL = "http://192.168.137.171:8080/WS_CONUNI_JAVA_GR6/api/conversor";
    ...
    private static Conversor llamarServicio(String endpoint, double valor) throws Exception {
        ...
        if (responseCode != HttpURLConnection.HTTP_OK) {
            throw new Exception("Error HTTP: " + responseCode + " en endpoint " + endpoint);
        }
