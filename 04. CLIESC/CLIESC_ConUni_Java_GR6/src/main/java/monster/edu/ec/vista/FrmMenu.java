...
public class FrmMenu extends JFrame {
    ...
    private void initComponents() {
        ...
        JLabel lblDescripcion = new JLabel("Temperatura, longitud y masa con acceso al servicio REST.", SwingConstants.CENTER);
        ...
        JPanel cards = new JPanel(new java.awt.GridLayout(1, 3, 20, 20));
        cards.setOpaque(false);

        cards.add(crearTarjeta("Temperatura", "Celsius, Fahrenheit y Kelvin",
                new Color(37, 99, 235), e -> abrirConversor(FrmConversor.Categoria.TEMPERATURA)));
        cards.add(crearTarjeta("Longitud", "Kilometros, metros, pulgadas, pies y millas",
                new Color(14, 165, 233), e -> abrirConversor(FrmConversor.Categoria.LONGITUD)));
        cards.add(crearTarjeta("Masa", "Kilogramos, gramos, libras, onzas y toneladas",
                new Color(16, 185, 129), e -> abrirConversor(FrmConversor.Categoria.MASA)));
    ...
    private JPanel crearTarjeta(String titulo, String detalle, Color accent, java.awt.event.ActionListener action) {
        ...
        JLabel lblDetalle = new JLabel("<html><div style='width: 200px;'>" + detalle + "</div></html>");
